        ...
        <tbody>
            @foreach ($pinjam as $index=>$p)
                <tr>
                    ...
                    <td>{{$p->buku->judul}}</td> --}}
                    <td>{{ optional($p->petugas)->nama_petugas }}</td>
                    <td>{{ optional($p->anggota)->nama_anggota }}</td>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form name="formpinjamedit" id="formpinjamedit" action="/{{ Auth::user()->role }}/pinjam/edit/{{ $p->id_pinjam}} " method="post" enctype="multipart/form-data">
                                            @csrf
                                            {{ method_field('PUT') }}
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form name="formpinjamtambah" id="formpinjamtambah" action="/{{ Auth::user()->role }}/pinjam/tambah " method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group row">
