...
@section('isihalaman')
    ...
    <p>
    <h4>Perpustakaan</h4>
        Perpustakaan Perguruan Tinggi Universitas Mercu Buana merupakan Perguruan Tinggi yang bersama-sama
    ...
    <p>
    <h4>Perpustakaan UMB</h4>
        Perpustakaan Universitas Mercu Buana sebagai salah satu perpustakaan perguruan tinggi swasta di Indonesia
		...
		ditempat yang cukup representative, mudah diakses baik oleh mahasiswa ataupun kalangan civitas akademika UMB.
		Disamping itu juga memiliki ribuan koleksi mulai dari Buku, Jurnal, Majalah, Dokumen Penelitian dan berbagai sumber
		referensi lain guna menunjang proses pembelajaran di UMB.
    ...
    <p>
		...
		ditiap tahunnya yaitu dengan rata-rata 5,18 % pertahun. Perpustakaan Universitas Mercu Buana sampai 10 Oktober 2020
